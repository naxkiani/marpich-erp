"""ACL: Collective super intelligence to platform peers (P218-W)."""
...
def to_enterprise_space(*, tenant_id: str, collective_si_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "collective_si_ref", collective_si_ref,
        via_enterprise_space=True, module_local_collective_si_forbidden=True,
