"""ACL: Sustainability intelligence to platform peers (P218-Q)."""
...
def to_exploration(*, tenant_id: str, exploration_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "exploration_ref", exploration_ref, via_p218_l=True, never_replace_p218_l_exploration=True, never_skip_planetary_protection_compliance=True)
...
def to_audit(*, tenant_id: str, audit_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "audit_ref", audit_ref, via_audit=True, never_opaque_unexplainable_sustainability_decisions=True, never_opaque_unexplainable_decisions=True)
...
def to_enterprise_space(*, tenant_id: str, sustainability_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "sustainability_ref", sustainability_ref,
        via_enterprise_space=True, module_local_sustainability_forbidden=True,
