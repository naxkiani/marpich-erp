"""ACL: Space communications layer to peers (P218-H)."""
...
def to_quantum_supreme(*, tenant_id: str, supreme_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "supreme_ref": supreme_ref, "via_p215_z": True, "never_replace_p215_z": True, "quantum_ready": True, "peer_ids_only": True}
...
def to_integration(*, tenant_id: str, integration_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "integration_ref": integration_ref, "via_integration": True, "no_module_local_telemetry_stack": True, "no_module_local_communications_radio_stack": True, "peer_ids_only": True}
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "workflow_ref": workflow_ref, "via_workflow": True, "never_opaque_mission_critical_strategy": True, "never_ungated_autonomous_mission_strategy": True, "never_ungated_command_transport": True, "never_disable_human_override": True, "never_skip_human_mission_oversight_strategy": True, "peer_ids_only": True}
...
def to_enterprise_space(*, tenant_id: str, communications_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "communications_ref": communications_ref,
        "via_enterprise_space": True,
        "module_local_communications_forbidden": True,
