"""ACL: Education intelligence to platform peers (P218-S)."""
...
def to_scientific(*, tenant_id: str, scientific_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "scientific_ref", scientific_ref, via_p218_k=True, never_replace_p218_k_scientific=True, never_skip_research_ethics_review=True)
...
def to_audit(*, tenant_id: str, audit_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "audit_ref", audit_ref, via_audit=True, never_opaque_unexplainable_education_decisions=True)


def to_identity(*, tenant_id: str, identity_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "identity_ref", identity_ref, via_identity=True, never_skip_credential_verification=True)
...
def to_enterprise_space(*, tenant_id: str, education_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "education_ref", education_ref,
        via_enterprise_space=True, module_local_education_forbidden=True,
