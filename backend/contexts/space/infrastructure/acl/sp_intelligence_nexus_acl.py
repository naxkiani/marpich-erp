"""ACL: Final intelligence nexus to platform peers (P218-Z)."""
...
def to_ultimate_governance(*, tenant_id: str, ultimate_governance_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "ultimate_governance_ref", ultimate_governance_ref, via_p218_y=True, never_replace_p218_y_ultimate_governance=True)
...
def to_enterprise_space(*, tenant_id: str, intelligence_nexus_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "intelligence_nexus_ref", intelligence_nexus_ref,
        via_enterprise_space=True, module_local_intelligence_nexus_forbidden=True,
