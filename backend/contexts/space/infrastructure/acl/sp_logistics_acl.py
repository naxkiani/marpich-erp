"""ACL: Logistics intelligence to platform peers (P218-O)."""
...
def to_enterprise_space(*, tenant_id: str, logistics_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "logistics_ref", logistics_ref,
        via_enterprise_space=True, module_local_logistics_forbidden=True,
