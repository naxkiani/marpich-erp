"""ACL: Space strategic architecture layer to peers (P218-B)."""
...
def to_enterprise_space(*, tenant_id: str, strategy_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "strategy_ref": strategy_ref, "via_enterprise_space": True, "module_local_space_strategy_forbidden": True, "peer_ids_only": True}
