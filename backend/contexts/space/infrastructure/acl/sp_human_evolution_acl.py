"""ACL: Human evolution intelligence to platform peers (P218-U)."""
...
def to_audit(*, tenant_id: str, audit_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "audit_ref", audit_ref, via_audit=True, never_opaque_unexplainable_evolution_decisions=True)


def to_identity(*, tenant_id: str, identity_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "identity_ref", identity_ref, via_identity=True,
        never_skip_human_consent=True, never_violate_human_sovereignty=True,
...
def to_enterprise_space(*, tenant_id: str, human_evolution_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "human_evolution_ref", human_evolution_ref,
        via_enterprise_space=True, module_local_human_evolution_forbidden=True,
