"""ACL: Human general intelligence to platform peers (P218-V)."""
...
def to_identity(*, tenant_id: str, identity_ref: str) -> dict[str, Any]:
    return _peer(
        ...
        never_skip_cognitive_privacy=True, never_violate_cognitive_sovereignty=True,
        never_skip_human_authority_preservation=True,
    )
...
def to_enterprise_space(*, tenant_id: str, human_gi_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "human_gi_ref", human_gi_ref,
        via_enterprise_space=True, module_local_human_gi_forbidden=True,
