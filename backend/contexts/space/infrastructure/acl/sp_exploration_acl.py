"""ACL: Exploration intelligence to platform peers (P218-L)."""
...
def to_enterprise_space(*, tenant_id: str, exploration_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "exploration_ref", exploration_ref,
        via_enterprise_space=True, module_local_exploration_forbidden=True,
