"""ACL: Space infrastructure layer to peers (P218-D)."""
...
def to_observability_platform(*, tenant_id: str, observability_ref: str) -> dict[str, Any]:
...
def to_integration_platform(*, tenant_id: str, integration_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "integration_ref": integration_ref, "via_integration_platform": True, "never_direct_ground_station_bypass_of_integration_platform": True, "peer_ids_only": True}
...
def to_enterprise_space(*, tenant_id: str, infra_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "infra_ref": infra_ref, "via_enterprise_space": True, "module_local_space_infrastructure_forbidden": True, "peer_ids_only": True}
