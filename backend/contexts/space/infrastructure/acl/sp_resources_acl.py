"""ACL: Resource intelligence to platform peers (P218-N)."""
...
def to_enterprise_space(*, tenant_id: str, resources_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "resources_ref", resources_ref,
        via_enterprise_space=True, module_local_resources_forbidden=True,
