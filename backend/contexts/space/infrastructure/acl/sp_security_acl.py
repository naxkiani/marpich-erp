"""ACL: Security intelligence to platform peers (P218-P)."""
...
def to_satellite(*, tenant_id: str, satellite_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "satellite_ref", satellite_ref, via_p218_f=True, never_replace_p218_f_satellite=True, never_skip_satellite_identity_verification=True)
...
def to_audit(*, tenant_id: str, audit_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "audit_ref", audit_ref, via_audit=True, never_opaque_unexplainable_security_decisions=True, never_opaque_unexplainable_decisions=True)


def to_identity(*, tenant_id: str, identity_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "identity_ref", identity_ref, via_identity=True, never_skip_command_authentication=True)
...
def to_enterprise_space(*, tenant_id: str, security_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "security_ref", security_ref,
        via_enterprise_space=True, module_local_security_forbidden=True,
