"""ACL: Orbital intelligence layer to peers (P218-G)."""
...
def to_integration(*, tenant_id: str, integration_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "integration_ref": integration_ref, "via_integration": True, "no_module_local_telemetry_stack": True, "no_module_local_ssa_sensor_stack": True, "peer_ids_only": True}
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "workflow_ref": workflow_ref, "via_workflow": True, "never_opaque_mission_critical_strategy": True, "never_ungated_autonomous_mission_strategy": True, "never_ungated_collision_avoidance_maneuver": True, "never_disable_human_override": True, "never_skip_human_mission_oversight_strategy": True, "peer_ids_only": True}
...
def to_enterprise_space(*, tenant_id: str, orbital_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "orbital_ref": orbital_ref,
        "via_enterprise_space": True,
        "module_local_orbital_forbidden": True,
