"""ACL: Civilization singularity intelligence to platform peers (P218-X)."""
...
def to_enterprise_space(*, tenant_id: str, singularity_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "singularity_ref", singularity_ref,
        via_enterprise_space=True, module_local_singularity_forbidden=True,
