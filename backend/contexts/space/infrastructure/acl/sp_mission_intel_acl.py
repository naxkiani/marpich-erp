"""ACL: Mission intelligence to platform peers (P218-J)."""
...
def to_policy_engine(*, tenant_id: str, policy_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "policy_ref", policy_ref, via_policy_engine=True, never_ungated_mission_launch_authorization=True, never_skip_mission_readiness_review=True)


def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "workflow_ref", workflow_ref, via_workflow=True, never_ungated_mission_launch_authorization=True, never_skip_mission_readiness_review=True, never_disable_human_override=True)
...
def to_enterprise_space(*, tenant_id: str, mission_intel_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "mission_intel_ref", mission_intel_ref,
        via_enterprise_space=True, module_local_mission_intel_forbidden=True,
