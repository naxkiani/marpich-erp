"""ACL: Space AI layer to peers (P218-E)."""
...
def to_enterprise_space(*, tenant_id: str, space_ai_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "space_ai_ref": space_ai_ref,
        "via_enterprise_space": True,
        "module_local_space_ai_forbidden": True,
