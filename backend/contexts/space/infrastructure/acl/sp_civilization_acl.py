"""ACL: Civilization intelligence to platform peers (P218-T)."""
...
def to_audit(*, tenant_id: str, audit_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "audit_ref", audit_ref, via_audit=True, never_opaque_unexplainable_civilization_decisions=True)


def to_identity(*, tenant_id: str, identity_ref: str) -> dict[str, Any]:
    return _peer(tenant_id, "identity_ref", identity_ref, via_identity=True, never_skip_human_rights_protection=True)
...
def to_enterprise_space(*, tenant_id: str, civilization_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "civilization_ref", civilization_ref,
        via_enterprise_space=True, module_local_civilization_forbidden=True,
