"""ACL: Manufacturing intelligence to platform peers (P218-M)."""
...
def to_enterprise_space(*, tenant_id: str, manufacturing_ref: str) -> dict[str, Any]:
    return _peer(
        tenant_id, "manufacturing_ref", manufacturing_ref,
        via_enterprise_space=True, module_local_manufacturing_forbidden=True,
