"""ACL: Quantum infrastructure layer to peers (P215-D)."""
...
def to_cryptographic_trust(*, tenant_id: str, trust_ref: str) -> dict[str, Any]: return {"tenant_id": tenant_id, "trust_ref": trust_ref, "via_p209": True, "peer_ids_only": True}
...
def to_enterprise_quantum(*, tenant_id: str, infra_ref: str) -> dict[str, Any]: return {"tenant_id": tenant_id, "infra_ref": infra_ref, "via_enterprise_quantum": True, "module_local_quantum_infrastructure_forbidden": True, "peer_ids_only": True}
