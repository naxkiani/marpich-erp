"""ACL: Quantum DDD domain layer to peers (P215-C)."""
...
def to_mission(*, tenant_id: str, mission_ref: str) -> dict[str, Any]: return {"tenant_id": tenant_id, "mission_ref": mission_ref, "via_p215_b": True, "peer_ids_only": True}
...
def to_enterprise_quantum(*, tenant_id: str, domain_ref: str) -> dict[str, Any]: return {"tenant_id": tenant_id, "domain_ref": domain_ref, "via_enterprise_quantum": True, "module_local_quantum_domain_forbidden": True, "peer_ids_only": True}
