...
def to_data_mesh(*, tenant_id: str, product_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "product_ref": product_ref,
        "via_p212_f": True,
        "data_mesh_alignment_present_required": True,
        "data_product_infrastructure": True,
        "peer_ids_only": True,
    }


def to_marketplace(*, tenant_id: str, listing_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
