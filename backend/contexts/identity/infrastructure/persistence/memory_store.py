...
PERMISSION_CODES = [
    ...
    "data_isolation.verify",
    "directory.read",
    "directory.write",
    "directory.saml.write",
    ...
    "federation.write",
    "federation.admin",
    "federation.broker.execute",
    "federation.provision.execute",
    "federation.sync.execute",
    "federation.trust.write",
    "federation.fabric.read",
    "federation.fabric.write",
    "federation.ai.read",
    "federation.ai.infer",
    "federation.ai.admin",
    "twin.read",
