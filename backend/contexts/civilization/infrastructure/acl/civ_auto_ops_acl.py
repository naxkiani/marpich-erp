"""ACL: Civilization autonomous operations layer to peers (P219-U)."""
...
def to_civilization_human(*, tenant_id: str, human_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_violate_human_sovereignty_operations": True, "peer_ids_only": True,
    }
...
def to_enterprise_civilization(*, tenant_id: str, auto_ops_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "auto_ops_ref": auto_ops_ref,
        "via_enterprise_civilization": True,
        "module_local_autonomous_civilization_operations_forbidden": True,
