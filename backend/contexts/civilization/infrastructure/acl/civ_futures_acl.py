"""ACL: Civilization futures intelligence layer to peers (P219-S)."""
...
def to_civilization_human(*, tenant_id: str, human_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_violate_human_sovereignty_futures": True, "peer_ids_only": True,
    }
...
def to_enterprise_civilization(*, tenant_id: str, futures_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "futures_ref": futures_ref,
        "via_enterprise_civilization": True,
        "module_local_civilization_futures_forbidden": True,
