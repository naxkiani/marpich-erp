"""ACL: Civilization intelligence governance & alignment layer to peers (P219-T)."""
...
def to_civilization_human(*, tenant_id: str, human_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_violate_human_sovereignty_governance": True, "peer_ids_only": True,
    }
...
def to_enterprise_civilization(*, tenant_id: str, intel_gov_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "intel_gov_ref": intel_gov_ref,
        "via_enterprise_civilization": True,
        "module_local_civilization_intelligence_governance_forbidden": True,
