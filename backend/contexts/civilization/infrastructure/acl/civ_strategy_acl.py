"""ACL: Civilization strategic architecture layer to peers (P219-B)."""
...
def to_identity(*, tenant_id: str, identity_ref: str) -> dict[str, Any]:
    return {
        ...
        "via_identity": True, "never_violate_human_sovereignty_architecture": True, "peer_ids_only": True,
    }
...
def to_enterprise_civilization(*, tenant_id: str, strategy_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "strategy_ref": strategy_ref,
        "via_enterprise_civilization": True,
        "module_local_civilization_strategy_forbidden": True,
