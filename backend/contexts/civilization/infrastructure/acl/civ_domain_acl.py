"""ACL: Civilization DDD domain layer to peers (P219-C)."""
...
def to_identity(*, tenant_id: str, identity_ref: str) -> dict[str, Any]:
    return {
        ...
        "via_identity": True, "never_violate_human_sovereignty_domain": True, "peer_ids_only": True,
    }
...
def to_enterprise_civilization(*, tenant_id: str, domain_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "domain_ref": domain_ref,
        "via_enterprise_civilization": True,
        "module_local_civilization_domain_forbidden": True,
