"""ACL: Civilization general intelligence coordination layer to peers (P219-V)."""
...
def to_civilization_human(*, tenant_id: str, human_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_violate_human_sovereignty_intelligence_coordination": True, "peer_ids_only": True,
    }
...
def to_enterprise_civilization(*, tenant_id: str, gen_intel_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "gen_intel_ref": gen_intel_ref,
        "via_enterprise_civilization": True,
        "module_local_civilization_general_intelligence_coordination_forbidden": True,
