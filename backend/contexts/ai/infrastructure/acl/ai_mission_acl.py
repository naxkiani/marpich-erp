"""ACL: AI mission/vision/scope ↔ peers (P214-B)."""
...
def to_graph(*, tenant_id: str, entity_ref: str) -> dict[str, Any]:
    return {
        ...
        "via_p212_j": True,
        "via_p213_l": True,
        "knowledge_strategy_alignment": True,
        "peer_ids_only": True,
    }
...
def to_autonomous_di(*, tenant_id: str, decision_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
