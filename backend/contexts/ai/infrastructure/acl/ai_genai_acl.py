...
def to_agent_platform(*, tenant_id: str, agent_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "agent_ref": agent_ref,
        "via_p214_f": True,
        "future_agent_hooks": True,
        "peer_ids_only": True,
    }
