"""ACL: AI Knowledge / RAG ↔ peers (P214-G)."""
...
def to_agents(*, tenant_id: str, agent_ref: str) -> dict[str, Any]:
    return {
        ...
        "agent_ref": agent_ref,
        "via_p214_f": True,
        "agent_memory_alignment": True,
        "peer_ids_only": True,
    }


def to_documents(*, tenant_id: str, document_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "document_ref": document_ref,
        "via_documents": True,
        "document_id_only": True,
        "peer_ids_only": True,
    }


def to_search(*, tenant_id: str, index_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "index_ref": index_ref,
        "via_search": True,
...
def to_enterprise_ai(*, tenant_id: str, knowledge_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
