"""ACL: AGI cognitive core ↔ peers (P214-V)."""
...
def to_enterprise_ai(*, tenant_id: str, agi_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "agi_ref": agi_ref, "via_enterprise_ai": True, "module_local_agi_forbidden": True, "peer_ids_only": True}
