"""ACL: Biotechnology Bio Civilization layer to peers (P217-W)."""
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "workflow_ref": workflow_ref, "via_workflow": True, "opaque_bio_safety_strategy_forbidden": True, "never_skip_human_civilization_oversight": True, "never_skip_collective_bio_ethics_controls": True, "never_skip_human_bio_ai_symbiosis_controls": True, "never_unvalidated_civilization_scenario_release": True, "never_opaque_collective_decisions": True, "peer_ids_only": True}
...
def to_enterprise_biotechnology(*, tenant_id: str, bio_civilization_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "bio_civilization_ref": bio_civilization_ref,
        "via_enterprise_biotechnology": True,
        "module_local_biotechnology_bio_civilization_forbidden": True,
        "civilization_intelligence_via_p217w_acl_only": True,
        "bio_ai_via_p214z_acl_only": True, "bio_gi_cognition_via_p217v_acl_only": True,
        "simulation_via_p217g_acl_only": True, "autonomy_execution_via_p217u_acl_only": True,
        "future_evolution_via_p217t_acl_only": True, "security_via_p217s_acl_only": True,
