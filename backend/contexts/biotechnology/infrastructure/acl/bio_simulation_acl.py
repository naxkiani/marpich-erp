"""ACL: Biotechnology Simulation layer to peers (P217-G)."""
...
def to_robotics_supreme(*, tenant_id: str, robotics_ref: str) -> dict[str, Any]:
    return {
        ...
        "physical_validation_via_p216z_acl_only": True, "peer_ids_only": True,
    }
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_unvalidated_simulation_claims": True, "peer_ids_only": True,
    }
...
def to_enterprise_biotechnology(*, tenant_id: str, simulation_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "simulation_ref": simulation_ref,
        "via_enterprise_biotechnology": True,
        "module_local_biotechnology_simulation_forbidden": True,
