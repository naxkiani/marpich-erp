"""ACL: Biotechnology Bio Supply Chain layer to peers (P217-M)."""
...
def to_biotechnology_simulation(*, tenant_id: str, simulation_ref: str) -> dict[str, Any]:
    return {
        ...
        "supply_twins_via_p217g_acl_only": True, "peer_ids_only": True,
    }
...
def to_biotechnology_bio_manufacturing(*, tenant_id: str, manufacturing_ref: str) -> dict[str, Any]:
    return {
        ...
        "manufacturing_via_p217l_acl_only": True, "peer_ids_only": True,
    }
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_untraceable_biological_material_movement": True, "peer_ids_only": True,
    }
...
def to_inventory(*, tenant_id: str, inventory_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "inventory_ref": inventory_ref, "never_replace_inventory": True, "peer_ids_only": True}
...
def to_enterprise_biotechnology(*, tenant_id: str, bio_supply_chain_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "bio_supply_chain_ref": bio_supply_chain_ref,
        "via_enterprise_biotechnology": True,
        "module_local_biotechnology_bio_supply_chain_forbidden": True,
