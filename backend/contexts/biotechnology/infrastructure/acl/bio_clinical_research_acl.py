"""ACL: Biotechnology Clinical Research layer to peers (P217-J)."""
...
def to_biotechnology_simulation(*, tenant_id: str, simulation_ref: str) -> dict[str, Any]:
    return {
        ...
        "trial_simulation_via_p217g_acl_only": True, "peer_ids_only": True,
    }
...
def to_robotics_supreme(*, tenant_id: str, robotics_ref: str) -> dict[str, Any]:
    return {
        ...
        "lab_automation_via_p216z_acl_only": True, "peer_ids_only": True,
    }
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_skip_human_researcher_oversight": True, "peer_ids_only": True,
    }
...
def to_enterprise_biotechnology(*, tenant_id: str, clinical_research_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "clinical_research_ref": clinical_research_ref,
        "via_enterprise_biotechnology": True,
        "module_local_biotechnology_clinical_research_forbidden": True,
