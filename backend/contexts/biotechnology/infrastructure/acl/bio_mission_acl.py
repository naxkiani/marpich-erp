"""ACL: Biotechnology mission / strategy layer to peers (P217-A)."""
...
def to_enterprise_biotechnology(*, tenant_id: str, mission_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "mission_ref": mission_ref, "via_enterprise_biotechnology": True, "module_local_biotechnology_mission_forbidden": True, "peer_ids_only": True}
