"""ACL: Biotechnology Drug Discovery layer to peers (P217-K)."""
...
def to_biotechnology_simulation(*, tenant_id: str, simulation_ref: str) -> dict[str, Any]:
    return {
        ...
        "drug_twins_via_p217g_acl_only": True, "peer_ids_only": True,
    }
...
def to_biotechnology_clinical_research(*, tenant_id: str, clinical_research_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "clinical_research_ref": clinical_research_ref,
        "via_p217_j": True, "never_replace_p217_j_clinical_research": True,
        "clinical_translation_via_p217j_acl_only": True, "peer_ids_only": True,
    }
...
def to_robotics_supreme(*, tenant_id: str, robotics_ref: str) -> dict[str, Any]:
    return {
        ...
        "lab_execution_via_p216z_acl_only": True, "peer_ids_only": True,
    }
...
def to_quantum_supreme(*, tenant_id: str, supreme_ref: str) -> dict[str, Any]:
    return {
        ...
        "quantum_molecular_via_p215z_acl_only": True, "peer_ids_only": True,
    }
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_skip_human_scientific_oversight": True, "peer_ids_only": True,
    }
...
def to_enterprise_biotechnology(*, tenant_id: str, drug_discovery_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "drug_discovery_ref": drug_discovery_ref,
        "via_enterprise_biotechnology": True,
        "module_local_biotechnology_drug_discovery_forbidden": True,
