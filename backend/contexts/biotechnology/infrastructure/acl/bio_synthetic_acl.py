"""ACL: Biotechnology Synthetic Biology layer to peers (P217-F)."""
...
def to_robotics_supreme(*, tenant_id: str, robotics_ref: str) -> dict[str, Any]:
    return {
        ...
        "lab_robotics_via_p216z_acl_only": True, "peer_ids_only": True,
    }
...
def to_workflow(*, tenant_id: str, workflow_ref: str) -> dict[str, Any]:
    return {
        ...
        "never_unsupervised_synthetic_release": True, "peer_ids_only": True,
    }
...
def to_enterprise_biotechnology(*, tenant_id: str, synthetic_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "synthetic_ref": synthetic_ref,
        "via_enterprise_biotechnology": True,
        "module_local_biotechnology_synthetic_forbidden": True,
