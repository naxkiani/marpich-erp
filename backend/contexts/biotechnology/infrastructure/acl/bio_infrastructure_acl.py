"""ACL: Biotechnology infrastructure layer to peers (P217-D)."""
...
def to_integration(*, tenant_id: str, connector_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "connector_ref": connector_ref, "via_integration_platform": True, "never_direct_lab_hardware_bypass_of_integration_platform": True, "peer_ids_only": True}
...
def to_enterprise_biotechnology(*, tenant_id: str, infra_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id, "infra_ref": infra_ref,
        "via_enterprise_biotechnology": True,
        "module_local_biotechnology_infrastructure_forbidden": True,
