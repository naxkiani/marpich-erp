"""ACL: Autonomous mobility / connected vehicles / drones layer to peers (P216-H)."""
...
def to_integration_platform(*, tenant_id: str, connector_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "connector_ref": connector_ref, "via_integration_platform": True, "v2x_via_integration_platform_only": True, "never_direct_v2x_bypass": True, "peer_ids_only": True}
...
def to_enterprise_robotics(*, tenant_id: str, mobility_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "mobility_ref": mobility_ref,
        "via_enterprise_robotics": True,
        "module_local_mobility_platform_forbidden": True,
