"""ACL: Autonomous logistics / warehouse automation layer to peers (P216-G)."""
...
def to_wms(*, tenant_id: str, wms_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "wms_ref": wms_ref, "via_wms_api": True, "never_duplicate_wms_tms_core_logic": True, "peer_ids_only": True}

def to_tms(*, tenant_id: str, tms_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "tms_ref": tms_ref, "via_tms_api": True, "never_duplicate_wms_tms_core_logic": True, "peer_ids_only": True}
...
def to_enterprise_robotics(*, tenant_id: str, logistics_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "logistics_ref": logistics_ref,
        "via_enterprise_robotics": True,
        "module_local_logistics_platform_forbidden": True,
