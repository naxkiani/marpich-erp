"""ACL: Industrial automation / smart factory layer to peers (P216-F)."""
...
def to_integration(*, tenant_id: str, connector_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "connector_ref": connector_ref, "via_integration_platform": True, "ot_via_integration_platform_only": True, "never_direct_ot_protocol_bypass": True, "peer_ids_only": True}
...
def to_enterprise_robotics(*, tenant_id: str, industrial_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "industrial_ref": industrial_ref,
        "via_enterprise_robotics": True,
        "module_local_industrial_platform_forbidden": True,
