"""ACL: Robotics DDD domain layer to peers (P216-C)."""
...
def to_enterprise_robotics(*, tenant_id: str, domain_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "domain_ref": domain_ref,
        "via_enterprise_robotics": True,
        "module_local_robotics_domain_forbidden": True,
