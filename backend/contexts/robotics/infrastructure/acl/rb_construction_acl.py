"""ACL: Construction robotics / smart infrastructure layer to peers (P216-K)."""
...
def to_integration_platform(*, tenant_id: str, connector_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "connector_ref": connector_ref, "via_integration_platform": True, "bim_gis_scada_via_integration_platform_only": True, "never_direct_bim_gis_scada_bypass": True, "peer_ids_only": True}

def to_construction_peer(*, tenant_id: str, construction_ref: str) -> dict[str, Any]:
    return {"tenant_id": tenant_id, "construction_ref": construction_ref, "via_construction_api": True, "never_duplicate_construction_core_logic": True, "peer_ids_only": True}
...
def to_enterprise_robotics(*, tenant_id: str, construction_ref: str) -> dict[str, Any]:
    return {
        "tenant_id": tenant_id,
        "construction_ref": construction_ref,
        "via_enterprise_robotics": True,
        "module_local_construction_platform_forbidden": True,
